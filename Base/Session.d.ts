...
declare namespace Session {
	 ...
	 * </code></pre>
	 * 
	 * @returns a string that represents the user's language setting
	 */
	function getActiveUserLocale(): string
	/**
	 ...
	 * </code></pre>
	 * 
	 * @returns the user under whose authority the script is running
	 */
	 ...
	 * </code></pre>
	 * 
	 * @returns the time zone of the script
	 */
	 ...
	 * </code></pre>
	 * 
	 * @returns the temporary active user key
	 */
