declare class Ui {
	 ...
	 * @param prompt - The message to display in the dialog box.
	 * 
	 * @returns A representation of the user's response.
	 */
	prompt(
		prompt: string
	): PromptResponse
	 ...
	 * </code></pre>
	 * 
	 * @param userInterface - An <code><a target='_blank' href='https://developers.google.com/apps-script/reference/base/../html/html-output.html'>HtmlOutput</a></code>
	 ...
	 * @param userInterface - An <code><a target='_blank' href='https://developers.google.com/apps-script/reference/base/../html/html-output.html'>HtmlOutput</a></code>
	 *     representing the interface to display.
	 * @param title - The title of the dialog; overrides any title set by calling <code>setTitle()</code> on
